package com.example.kutubxona_project.config.jwtFilter;

import com.example.kutubxona_project.model.Users;
import com.example.kutubxona_project.service.auth.AuthServiceImpl;
...
public class JWTFilter extends OncePerRequestFilter {
    ...
    private void setAuthenticationBearer(HttpServletRequest request, String authorization) {
        ...
        if (userId != null) {
            ...
            Optional<Users> optionalUser = authServiceImpl.findUserById(Integer.valueOf(userId));
